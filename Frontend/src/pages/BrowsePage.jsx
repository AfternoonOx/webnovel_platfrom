                ...
                <div>
                  ...
                  <div className="flex space-x-2">
                    <button
                      ...
                      className={`flex-1 px-3 py-2 text-sm rounded-md ${sortOrder === 'desc'
                    ...
                    <button
                      ...
                      className={`flex-1 px-3 py-2 text-sm rounded-md ${sortOrder === 'asc'
                        ? 'bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300'
                        : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300'
                        }`}
                    >
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex space-x-2">
                        <button
                          ...
                          className={`flex-1 px-3 py-2 text-sm rounded-md transition-colors ${sortOrder === 'desc'
                            ? 'bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300'
                        ...
                        <button
                          ...
                          className={`flex-1 px-3 py-2 text-sm rounded-md transition-colors ${sortOrder === 'asc'
                            ? 'bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300'
                            : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600'
                            }`}
                        >
